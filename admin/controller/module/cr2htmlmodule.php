...
class ControllerModuleCR2HTMLModule extends Controller {
	...
	public function index() {
		...
		$this->data['entry_borderless1'] = $this->language->get('entry_borderless1');
		$this->data['entry_borderless2'] = $this->language->get('entry_borderless2');
		$this->data['entry_borderless3'] = $this->language->get('entry_borderless3');
