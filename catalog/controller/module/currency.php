...
//                echo 'codigo de moneda-> '.$this->request->post['currency_code'].'<br>';
		if (isset($this->request->post['currency_code'])) {
                   //print 'no entre-> <pre>'.print_r($this->request->post,true).'</pre>';
		...
		foreach ($results as $result) {
		 ...
		 //print 'entre-> <pre>'.print_r($this->request->post,true).'</pre>';
		if (!isset($this->request->get['route'])) {
			$this->data['redirect'] = $this->url->link('common/home');
//                        echo $this->data['redirect'].'<br>';
		} else {
