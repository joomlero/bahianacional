...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
                $instPeso = new Weight($this->registry);
                $instAlto = new Length($this->registry);
...
//		
		if ($product_info) {
			$url = '';
                        ...
                        if(isset($product_info['weight']) && $product_info['weight'] > 0){
                            $this->data['text_weight_product'] = $instPeso->format($product_info['weight'],$product_info['weight_class_id']);
                        } else {
                            $this->data['text_weight_product'] = 0;
                        }
                        
                        if(isset($product_info['length']) && $product_info['length'] > 0){
                            $this->data['text_length_product'] = $instAlto->format($product_info['length'],$product_info['length_class_id']);
                        } else {
                            $this->data['text_length_product'] = 0;
                        }
                        
                        if(isset($product_info['height']) && $product_info['height'] > 0){
                            $this->data['text_height_product'] = $instAlto->format($product_info['height'],$product_info['length_class_id']);
                        } else {
                        ...
                        if(isset($product_info['width']) && $product_info['width'] > 0){
                            ...
                            $this->data['text_width_product'] = 0;
                        }
			...
			$this->data['text_relacionado'] = $this->language->get('text_relacionado');
