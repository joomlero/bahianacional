    ...
    <?php foreach ($banners as $banner) { ?>
		<li>
			<?php if($use_table) {
				...
				$output_thumbnail .= '<tr><td class="gallery_thumb_image" style="' . $output_tblinstyle . '"><a href="' . $banner['image'] . '" title="' . $banner['title'] . '" class="fancybox" rel="fancybox"><img src="' . $banner['thumbnail'] . '" title="' . $banner['title'] . '" alt="' . $banner['title'] .'" /></a></td></tr>';
