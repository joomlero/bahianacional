...
jQuery(document).ready(function(){
	...
	$('#search-bottom input[name=\'filter_name\']').bind('keydown', function(e) {
		if (e.keyCode == 13) {
			url = $('base').attr('href') + 'index.php?route=product/search';
	...
	// HOVER EFFECT on IMAGES		
		...
		//$('.product-listing a.thumb img, .list-view a.thumb img, #blog .post a.post-feature-image img').fadeTo('slow', 1.0);
		
		
		$('.product-listing a.thumb img, .grid-view a.thumb img, .list-view a.thumb img, #blog .post a.post-feature-image img').hover(
		//$('.product-listing a.thumb img, .list-view a.thumb img, #blog .post a.post-feature-image img').hover(
