...
<!--[if (gt IE 9)|!(IE)]><!--> <body> <!--<![endif]-->
    ...
    <div style="position: fixed; top:0; background: transparent; z-index: 999999; width: 100%;">
	<div class="header-wrapper">
            ...
            <div id="header" class="clearfix">
                    ...
                    <a href="<?php echo $home; ?>" class="logo">
                        <div style="width: 730px; height: 140px; margin-left: 100px;">
                            <div style="margin: 0 auto; width: auto; height: 140px; background: url('<?php echo $logo; ?>') no-repeat center;">
                                <!--<img src="<?php echo $logo; ?>" alt="<?php echo $name; ?>" style="margin:0 auto; display: inline-table"/>-->
                            </div>
                        </div>
                    </a>
