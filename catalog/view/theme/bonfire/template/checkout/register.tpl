<div class="left">
  ...
  <input type="text" name="telephone" value="" class="text" />
  <br />
  <br />
  <label><?php echo $entry_fax; ?></label><br />
  <input type="text" name="fax" value="" class="text" />
  <br />
  <br />
  <h3><span><?php echo $text_your_password; ?></span></h3>
  <label><span class="required">*</span> <?php echo $entry_password; ?></label><br />
  <input type="password" name="password" value="" class="text" />
  <br />
  <br />
  <label><span class="required">*</span> <?php echo $entry_confirm; ?></label> <br />
  <input type="password" name="confirm" value="" class="text" />
  <br />
  <br />
  <br />
</div>
<div class="right">
  ...
  <input type="text" name="company" value="" class="text" />
  <br />
  <br />
...
<div class="buttons">
  <div style="float: right;"><p class="msg"><?php echo $text_agree; ?>
    ...
    <input type="button" value="<?php echo $button_continue; ?>" id="button-register" class="button cont" /></p>
  </div>
</div>
<?php } else { ?>
<div class="buttons">
  <div style="float: right;"><input type="button" value="<?php echo $button_continue; ?>" id="button-register" class="button cont" /></div>
</div>
<?php } ?>
