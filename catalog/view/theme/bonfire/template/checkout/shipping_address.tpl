...
<div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  <table class="form">
    ...
    <tr>
      ...
      <td><input type="text" name="address_1" value="" class="text" /></td>
    </tr>
    <tr>
      <td><label><?php echo $entry_address_2; ?></label></td>
      <td><input type="text" name="address_2" value="" class="text" /></td>
    </tr>
    <tr>
      <td><label><span class="required">*</span> <?php echo $entry_city; ?></label></td>
      <td><input type="text" name="city" value="" class="text" /></td>
    </tr>
    <tr>
      <td><label><span id="shipping-postcode-required" class="required">*</span> <?php echo $entry_postcode; ?></label></td>
      <td><input type="text" name="postcode" value="<?php echo $postcode; ?>" class="text" /></td>
    </tr>
    <tr>
      <td><label><span class="required">*</span> <?php echo $entry_country; ?></label></td>
      <td><select name="country_id" class="text" style="width: 340px; overflow:hidden;">
    ...
    <tr>
      <td><label><span class="required">*</span> <?php echo $entry_zone; ?></label></td>
      <td><select name="zone_id" class="text" style="width: 340px; overflow:hidden;">
        </select></td>
    </tr>
  </table>
</div>
<br />
<div class="buttons">
  <div style="float: right;"><input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" class="button cont" /></div>
</div>
...
$('#shipping-address select[name=\'country_id\']').bind('change', function() {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-address select[name=\'country_id\']').after('<span class="wait">&nbsp;<img src="catalog/view/theme/bonfire/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
			$('.wait').remove();
		},			
