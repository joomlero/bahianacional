...
<div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
  <table class="form">
	...
	<tr style="display: <?php echo ($company_id_display ? 'table-row' : 'none'); ?>;">
      ...
      <td><input type="text" name="company_id" value="" class="text" /></td>
    </tr>
    <tr style="display: <?php echo ($tax_id_display ? 'table-row' : 'none'); ?>;">
      ...
      <td><input type="text" name="tax_id" value="" class="text" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="text" name="postcode" value="" class="text" /></td>
    </tr>
    <tr>
...
<br />
<div class="buttons">
  <div style="float: right;"><input type="button" value="<?php echo $button_continue; ?>" id="button-payment-address" class="button cont" /></div>
</div>
