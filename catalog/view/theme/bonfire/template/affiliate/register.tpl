...
<div class="inner-container clearfix"><?php echo $content_top; ?>
	...
	<div class="account">
	  ...
	  <p class="msg"><?php echo $text_account_already; ?></p>
	  <p class="msg"><?php echo $text_signup; ?></p>
	  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
		...
		<div class="content">
		  <table class="form">
			...
			<tr>
			  ...
			  <td><input type="text" name="website" value="<?php echo $website; ?>" class="text"/></td>
			</tr>
			<tr>
		...
		<h3><span><?php echo $text_payment; ?></span></h3>
		<div class="content">
		  <table class="form">
			<tbody>
			  <tr>
				<td><?php echo $entry_tax; ?></td>
				<td><input type="text" name="tax" value="<?php echo $tax; ?>" class="text"/></td>
			  </tr>
			  <tr>
			...
			<tbody id="payment-cheque" class="payment">
			  <tr>
				...
				<td><input type="text" name="cheque" value="<?php echo $cheque; ?>" class="text"/></td>
			  </tr>
			</tbody>
			<tbody class="payment" id="payment-paypal">
			  <tr>
				<td><?php echo $entry_paypal; ?></td>
				<td><input type="text" name="paypal" value="<?php echo $paypal; ?>" class="text"/></td>
			  </tr>
			</tbody>
			<tbody id="payment-bank" class="payment">
			  <tr>
				<td><?php echo $entry_bank_name; ?></td>
				<td><input type="text" name="bank_name" value="<?php echo $bank_name; ?>" class="text"/></td>
			  </tr>
			  <tr>
				<td><?php echo $entry_bank_branch_number; ?></td>
				<td><input type="text" name="bank_branch_number" value="<?php echo $bank_branch_number; ?>" class="text"/></td>
			  </tr>
			  <tr>
				<td><?php echo $entry_bank_swift_code; ?></td>
				<td><input type="text" name="bank_swift_code" value="<?php echo $bank_swift_code; ?>" class="text"/></td>
			  </tr>
			  <tr>
				<td><?php echo $entry_bank_account_name; ?></td>
				<td><input type="text" name="bank_account_name" value="<?php echo $bank_account_name; ?>" class="text"/></td>
			  </tr>
			  <tr>
				<td><?php echo $entry_bank_account_number; ?></td>
				<td><input type="text" name="bank_account_number" value="<?php echo $bank_account_number; ?>" class="text"/></td>
			  </tr>
			</tbody>
		  </table>
		</div>
		...
		<?php if ($text_agree) { ?>
		<div class="buttons">
		  <div class="right"><p class="msg"><?php echo $text_agree; ?>
			<?php if ($agree) { ?>
