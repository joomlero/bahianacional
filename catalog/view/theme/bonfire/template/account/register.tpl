<?php echo $header; ?>
<script type="text/javascript" src="catalog/view/theme/bonfire/js/funcionesRegistro.js"></script>
<?php if ($error_warning) { ?>
<div class="warning"><?php echo $error_warning; ?></div>
<?php } ?>
<div class="warning" id="error_email" style="display:none;"><span class="error"><?php echo $error_confirm_email; ?></span></div>
	...
	<!-- END of BREADCRUMBS -->
		<div class="account">
                    ...
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                        <div class="content">
                            <table class="form" style="width: 342px; margin: 0 auto 0 auto;">
                                  <tr>
                                    <td><?php echo $entry_firstname; ?><br>
                                  ...
                                  <tr>
                                    <td><?php echo $entry_email_confirm; ?><br>
                                        <input type="text" id="confirma-email" name="confirma-email" value="" class="text" onblur="confirmaEmail();"/>
                                  </tr>
                                  <tr>
                                    <td><?php echo $entry_password; ?><br>
                                        <input type="password" name="password" value="<?php echo $password; ?>" class="text"/>
                                          <?php if ($error_password) { ?>
                                          <span class="error"><?php echo $error_password; ?></span>
                                          <?php } ?></td>
                                  </tr>
                                  <tr>
                                    <td><?php echo $entry_confirm; ?><br>
                                        <input type="password" name="confirm" value="<?php echo $confirm; ?>" class="text"/>
                        ...
                        <div class="content">
                            <table class="form">
                                ...
                                <tr id="company-id-display">
                                  ...
                                  <td><input type="text" name="company_id" value="<?php echo $company_id; ?>" class="text" />
                                ...
                                <tr id="tax-id-display">
                                  ...
                                  <td><input type="text" name="tax_id" value="<?php echo $tax_id; ?>" class="text" />
                                        <?php if ($error_tax_id) { ?>
                        ...
                        <h3><span><?php echo $text_your_password; ?></span></h3>
                        <div class="content">
                            <table class="form">
                                <tr>
                        ...
                        <h3><span><?php echo $text_newsletter; ?></span></h3>
                        <div class="content">
                            <table class="form">
                                <tr>
                        ...
                        <?php */?>
                            <?php if ($text_agree) { ?>
                            <div class="buttons">
                              <div class="right"><p><?php echo $text_agree; ?>
                                    <?php if ($agree) { ?>
                                    <input type="checkbox" name="agree" value="1" checked="checked" />
                                    <?php } else { ?>
                                    <input type="checkbox" name="agree" value="1" />
                                    <?php } ?>
                                    <input type="submit" value="<?php echo $button_continue; ?>" class="button cont" /></p>
                              </div>
                            </div>
                            <?php } else { ?>
		...
		<div id="login-footer">
                <p style="margin-top: 20px; text-align: center; font-style: italic; font-size:13px; font-family: Arial,Helvetica,sans-serif;"><?php echo $text_account_already; ?></p>
