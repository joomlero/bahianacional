  ...
  <table class="table_style">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/bonfire/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
    ...
    <tr>
      <td></td>
      <?php foreach ($products as $product) { ?>
      <td><input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button cont" /></td>
      <?php } ?>
    </tr>
    <tr>
      <td></td>
      <?php foreach ($products as $product) { ?>
      <td class="remove"><a href="<?php echo $product['remove']; ?>" class="button cont"><?php echo $button_remove; ?></a></td>
      <?php } ?>
    </tr>
  </table>
  <?php } else { ?>
  <div class="inner-container clearfix"><p class="msg"><?php echo $text_empty; ?></p>
  <div class="buttons">
